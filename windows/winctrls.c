...
{
    RECT r, r2;
    /* PuttyTray hack / System font (8 lines) */
    ...
    cp->hwnd = hwnd;
    cp->font = (WPARAM)CreateFontIndirect(&(ncm.lfMessageFont));    /* PuttyTray hack / System font (added this line) */
    //cp->font = SendMessage(hwnd, WM_GETFONT, 0, 0);               /* PuttyTray hack / System font (commented this line) */
...
char *staticwrap(struct ctlpos *cp, HWND hwnd, char *text, int *lines)
{
     ...
     */
    newfont = CreateFontIndirect(&(ncm.lfMessageFont));     /* PuttyTray hack / System font (added this line) */
    //newfont = (HFONT)SendMessage(hwnd, WM_GETFONT, 0, 0); /* PuttyTray hack / System font (commented this line) */
...
/* PuttyTray hack / Session Icon function (16 lines) */ 
		    ...
		    struct ctlpos *cp, struct controlset *s, int *id)
{
	...
	switch (ctrl->generic.type) {
	  ...
	  case CTRL_EDITBOX:
	    ...
	    sfree(escaped);
	    break;
      /* PuttyTray hack / Session Icon case (4 lines) */ 
      case CTRL_ICON:
            num_ids = 1;
...
/* PuttyTray hack / Session Icon function (10 lines) */ 
...
/* PuttyTray / Session Icon function (7 lines) */ 
